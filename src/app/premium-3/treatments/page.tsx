...
import { Leaf, Layers, Sparkles, Zap, SlidersHorizontal, Heart, AlertTriangle, Award, Droplets } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          ...
          <nav aria-label="ניווט ראשי">
            <ul className="hidden md:flex items-center gap-7 list-none">
              ...
              <li><Link href="/premium-3/treatments" className="text-sm font-medium"
                style={{ color: "var(--accent)" }}>טיפולים</Link></li>
